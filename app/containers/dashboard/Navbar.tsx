  ...
  return (
    <div className="flex items-center justify-between px-6 py-4 bg-white shadow-sm border-b-[1px] border-[#E5E5E5]">
      ...
      <div className="flex items-center gap-6">
        <div className="relative flex items-center justify-center w-10 h-10 bg-gray-100 rounded-[15px] hover:bg-gray-200 cursor-pointer">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center justify-center w-10 h-10 bg-gray-100 cursor-pointer rounded-[15px]">
